...
router.get('/me', auth, 
    async (req, res)=>{
//req.user comes from the auth (middleware), req.user = decoded.user
        try{
...
router.post('/', [ auth, 
    ...
    try{
        ...
        //if profile exist then, we can update it
        if(profile){
            //Update
        ...
        //if there is no profile, then we have to create one
...
//@desc     DELETE profile education by edu_id
//@access   Private
